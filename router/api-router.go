	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invitees", controller.GetInvitedUsers)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/export", middleware.CriticalRateLimit(), controller.ExportUsers)
				...
				adminRoute.DELETE("/:id/channel-bindings/:channelId", controller.DeleteUserChannelBinding)
